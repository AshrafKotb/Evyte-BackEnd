...
namespace Eventa.ApplicationCore.Services.Designs
{
    public class DesignService : IDesignService
    {
        ...
        public async Task<Design> CreateDesignAsync(CreateDesignVM model)
        {
            ...
            var design = new Design
            {
                ...
                WebsiteDemoUrl = $"/design/preview/{sanitizedTemplateName}", // ????? ??????
        ...
        public async Task<Design> UpdateDesignAsync(Guid id, UpdateDesignVM model)
        {
            ...
            design.WebsiteDemoUrl = $"/design/preview/{sanitizedTemplateName}"; // ????? ??????
