...
namespace Eventa.Infrastructure.Migrations
{
    ...
    [Migration("20250501095128_EditGeneralInformation")]
    partial class EditGeneralInformation
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("Eventa.Domain.Entities.Request", b =>
                {
                    ...
                    b.HasOne("Eventa.Domain.Entities.Design", "Design")
                        .WithOne()
                        .HasForeignKey("Eventa.Domain.Entities.Request", "DesignId")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();

                    b.HasOne("Eventa.Domain.Entities.Design", null)
                        .WithMany("Requests")
